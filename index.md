...
carpentry: "combine"    # what kind of Carpentry (must be either "lc" or "dc" or "swc").
                      # Be sure to update the Carpentry type in _config.yml as well.
venue: "Walter and Eliza Hall Institute"        # brief name of host site without address (e.g., "Euphoric State University")
...
language: "gb"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "-37.799351,144.956055"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
{% elsif page.carpentry == "combine" %}
{% include combine/intro.html %}
{% endif %}
...
{% endcomment %}
<p>
  <strong>Registrations:</strong> Register on the
  <a href="https://www.abacbs.org/events/abacbs-supported-event#!event-register/2019/9/16/combine-melbourne-r-package-development-workshop">ABACBS website</a>.
</p>
...
Logos for sponsors go here
{% endcomment %}
<h2 id="syllabus">Sponsors</h2>
...
<p>
  A list of common issues that occur during installation can be found on
...
<div id="r"> {% comment %} Start of 'R' section. {% endcomment %}
  ...
  <p>
    ...
    <a href="https://www.r-project.org">R</a> installed. We will also be using
    <a href="https://www.rstudio.com/">RStudio</a> for the workshop so make sure
...
<div id="git"> {% comment %} Start of 'Git' section. GitHub browser compatibility
  ...
  <p>
    ...
    <a href="https://github.com/">github.com</a>. Basic GitHub accounts are
  ...
  <div>
    ...
    <div class="tab-content">
      <article role="tabpanel" class="tab-pane active" id="git-windows">
        <p>
          Git for windows can be downloaded from <a href="https://git-scm.com/downloads">here</a>.
        </p>
      </article>
